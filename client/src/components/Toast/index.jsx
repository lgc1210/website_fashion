...
const Toast = ({ visible, message, type, onClose }) => {
  ...
  return (
    <div
      id='toast-success'
      className={`toast-shadow transition-all duration-300 fixed top-4 right-4 z-50 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-md dark:text-gray-400 dark:bg-gray-800
        ${
          visible
